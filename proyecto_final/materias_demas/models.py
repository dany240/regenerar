...
class personas(models.Model):
    ...
    usuario=models.ForeignKey( settings.AUTH_USER_MODEL,on_delete=models.PROTECT,db_column='users')
    class Meta:
        managed = False
        db_table = 'personas'
...
class lectivo(models.Model):
    id=models.BigAutoField(primary_key=True,db_column='id',null=False,blank=False)
    years=models.BigIntegerField(db_column='years',max_length=5)
...
class periodo(models.Model):
    id_periodo=models.BigAutoField(primary_key=True,db_column='id_periodo',null=False,blank=False)
    fecha_incio=models.DateField(db_column='fecha_incio',null=False,blank=False)
    fecha_fin=models.DateField(db_column='fecha_fin',null=False,blank=False)
    lectivo=models.ForeignKey(lectivo,related_name='año_lect',on_delete=models.PROTECT,db_column='lectivo')
    class Meta:
        managed = False
        db_table = 'periodo'
...
class materia_periodo(models.Model):
    ...
    id_material=models.ForeignKey(materia,related_name='materia_per1',on_delete=models.PROTECT,db_column='id_material')
